...
```
-mllvm -sub -mllvm -sub_loop=3 -mllvm -split -mllvm -split_num=3 -mllvm -fla -mllvm -bcf -mllvm -bcf_loop=3 -mllvm -bcf_prob=40 -mllvm -string-obfus -mllvm -ind-call -mllvm -mba-subs -mllvm -const-obfus -mllvm -const-glb -mllvm -data-obfus
```
